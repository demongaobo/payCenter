...
return [
    ...
    //******评价系统
    'api.comment.create'=>'\App\Comment\Controllers\Api\v1\CommentController@create',
    'api.comment.detail'=>'\App\Comment\Controllers\Api\v1\CommentController@getDetail',
    'api.comment.setTop'=>'\App\Comment\Controllers\Api\v1\CommentController@setTop',
    'api.comment.cancelTop'=>'\App\Comment\Controllers\Api\v1\CommentController@cancelTop',
    'api.comment.setHidden'=>'\App\Comment\Controllers\Api\v1\CommentController@setHidden',
    'api.comment.cancelHidden'=>'\App\Comment\Controllers\Api\v1\CommentController@cancelHidden',
    'api.comment.examinePass'=>'\App\Comment\Controllers\Api\v1\CommentController@examinePass',
    'api.comment.examineNotPass'=>'\App\Comment\Controllers\Api\v1\CommentController@examineNotPass',
    'api.comment.getList'=>'\App\Comment\Controllers\Api\v1\CommentController@getList',
    'api.comment.getCommentList'=>'\App\Comment\Controllers\Api\v1\CommentController@getCommentList',
    'api.comment.getTopicDetail'=>'\App\Comment\Controllers\Api\v1\CommentController@getTopicDetail',
    'api.comment.searchCondition'=>'\App\Comment\Controllers\Api\v1\CommentController@searchCondition',
    'api.comment.importComment'=>'\App\Comment\Controllers\Api\v1\CommentController@importComment',
...
//**************************************************营销工具相关接口 **********************************************//
    ...
    //卡券暂停
    'api.tool.coupon.couponSuspend'=>'\App\Tools\Controllers\Api\v1\CouponBackendController@couponSuspend',
    //卡券恢复
    'api.tool.coupon.couponResume'=>'\App\Tools\Controllers\Api\v1\CouponBackendController@couponResume',
    
    //导入老系统数据 只能执行一次
    'api.tool.coupon.importOldData'=>'\App\Tools\Controllers\Api\v1\CouponBackendController@importOldData',
    ...
    'api.tool.coupon.received'=>'\App\Tools\Controllers\Api\v1\CouponFrontendController@received',
    ...
    //zuji.couponnew.receive 领取优惠券 用户主动领取优惠券
    'api.tool.coupon.couponUserReceiveStatus'=>'\App\Tools\Controllers\Api\v1\CouponFrontendController@couponUserReceiveStatus',
    ...
    //优惠券去使用功能
    'api.tool.coupon.couponToUse'=>'\App\Tools\Controllers\Api\v1\CouponFrontendController@couponGoToUse',
    
    /**
     * 优惠券订单系统
     */
    //zuji.couponnew.checked 优惠券商品可用列表查询接口
    'api.tool.coupon.couponListWhenOrder'=>'\App\Tools\Controllers\Api\v1\CouponSystemController@couponListWhenOrder',
    //zuji.coupon.voucher.get根据用户ID获取优惠券信息(租金抵用券)
    'api.tool.coupon.couponListWhenPay'=>'\App\Tools\Controllers\Api\v1\CouponSystemController@couponListWhenPay',
    //zuji.goods.coupon.status1.set 根据优惠券id设置该优惠券已使用 核销
    'api.tool.coupon.couponUserWriteOff'=>'\App\Tools\Controllers\Api\v1\CouponSystemController@couponUserWriteOff',
    //zuji.goods.coupon.status0.set 根据优惠券id恢复优惠券使用状态  撤销
    'api.tool.coupon.couponUserCancel'=>'\App\Tools\Controllers\Api\v1\CouponSystemController@couponUserCancel',
    //优惠券checked 返回列表
    'api.tool.coupon.couponUserChecked'=>'\App\Tools\Controllers\Api\v1\CouponSystemController@couponUserChecked',
...
//*********************************************************************************************************************//
    ...
    //订单商品评论
    'api.order.discussAdd'=>'OrderGoodsDiscussController@create',
    //-+------------------------------------------------------------------------
	// | 设备相关
    //-+------------------------------------------------------------------------

    //设备逾期详情
    'api.goods.overdueDetail' => 'GoodsController@overdueDetailByGoods',
    //设备逾期支付
    'api.goods.overduePay' => 'GoodsController@overduePayByGoods',
   ...
   //获取订单所有待审核的退换货信息
	...
	//长租续租
	//生成长租续租单
    'api.Relet.createReletLong'       => 'ReletController@createReletLong',
	//生成长租选择租期后的到期时间
    'api.Relet.calc.endTime'       => 'ReletController@calcEndTime',
	...
	//小程序还机赔偿支付接口
	'api.giveback.mini.pay'       => 'MiniGivebackController@pay',
   ...
   // 'api.test.overDueTest'       => 'TestController@overDueTest',
	...
	//小程序获取用户最新下单订单号接口
    'mini.order.getorderlist' => 'MiniOrderController@getOrderList',
    //小程序支付后查询支付状态接口
...
//    'mini.order.givebackcreate' => 'MiniGivebackController@givebackCreate',
	...
	//小程序赔付剩余未完成分期检测
	'mini.order.check.instalment' => 'MiniGivebackController@checkInstalment',
	//小程序还机分期扣除接口
    'mini.order.instalment.pay' => 'MiniGivebackController@instalmentPay',

    //小程序订单支付接口
    'mini.order.pay'=>'MiniOrderController@orderPay',
    ...
    ************************************************** 获取物流信息     ****************************************
    ***************************************************************************************************/
    'api.return.getWuliuInfo'                        => 'ReturnController@getWuliuInfo',       //获取物流信息

    /***************************************************************************************************
     ************************************************** 微信小程序相关接口 ****************************************
     ***************************************************************************************************/
    'api.giveback.getGivebackDetail'         => 'GivebackController@getGivebackDetail',       //获取还机详细信息
	
	
    'api.short.message.send'                   => 'ShortMessageController@send',       //发送短信


	// 商品管理接口
	// 商品列表
    'zuji.admin.spu.list'                   => 'SpuController@post',
	// 商品详情
    'zuji.admin.spu.detail'                 => 'SpuController@post',
	// 上下架
    'zuji.admin.spu.updown'                 => 'SpuController@post',
	// 审核
    'zuji.admin.spu.check'                  => 'SpuController@post',
	// 系统类目
    'zuji.admin.category.systemall'          => 'SpuController@post',
	// 系统类目
    'zuji.admin.category.systemall'          => 'SpuController@post',
    // 分类导航列表
    'zuji.admin.category.navall'          => 'SpuController@post',
    // 商品库列表
    'zuji.admin.channel.list'          => 'SpuController@post',
     ...
     ************************************************** 商家系统 ****************************************
     ***************************************************************************************************/
    'api.AgentRegister.AgentRegister'        => '\App\Order\Controllers\Api\v1\AgentRegisterController@AgentRegister',   //代理商注册
    'api.Shops.AddShops'                       => '\App\Order\Controllers\Api\v1\ShopsController@AddShops',                  //添加店铺
    'api.Shops.getShops'                       => '\App\Order\Controllers\Api\v1\ShopsController@getShops',                  //店铺列表
    'api.Shops.editShops'                      => '\App\Order\Controllers\Api\v1\ShopsController@EditShops',                 //编辑店铺
    'api.Shops.AgentList'                      => '\App\Order\Controllers\Api\v1\AgentRegisterController@AgentList',           //代理商列表
    'api.AgentRegister.getAgentInfo'           => '\App\Order\Controllers\Api\v1\AgentRegisterController@getAgentInfo',          //获取代理商信息
