...
return [
    ...
    'warehouse.delivery.channelSend' => 'DeliveryController@channelSend', //渠道自己发货
    ...
    'warehouse.delivery.shopLists' => 'DeliveryController@shopLists', //商家平台待发货列表查询
    ...
    'warehouse.delivery.onePrintmail' => 'DeliveryController@onePrintmail', //单独打印宅急送物流单
    ...
    'warehouse.delivery.importFromExcel'=> 'DeliveryController@importFromExcel', //Excel批量发货
    ...
    //库管
    'warehouse.address.lists'=> 'AddressController@lists', //列表
    'warehouse.address.addRow'=> 'AddressController@addRow', //添加
    'warehouse.address.getRow'=> 'AddressController@getRow', //根据id查询返回一条记录
    'warehouse.address.setRow'=> 'AddressController@setRow', //修改 每次修改完批量记录修改日志
    'warehouse.address.getUpdateLog'=> 'AddressController@getUpdateLog', //查询库管修改日志
    'warehouse.address.publics'=> 'AddressController@publics', //公共参数
    'warehouse.address.shopLists'=> 'AddressController@shopLists', //根据店铺ID查询店铺下所有地址信息
    'warehouse.address.shopAddRow'=> 'AddressController@shopAddRow', //添加店铺地址信息 批量
