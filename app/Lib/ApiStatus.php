...
class ApiStatus {
    ...
    // | 判断下单条件
    //-+----------------------------------------------------------------------
    const CODE_32100= '32100';   // 【下单判断】有有效订单
    const CODE_32101= '32101';   // 【下单判断】未认证通过
    //-+----------------------------------------------------------------------
    // | 订单相关操作
    //-+----------------------------------------------------------------------
    const CODE_32200='32200';//【订单操作】订单不能评论
    const CODE_32201='32201';//【订单操作】订单评论失败
     ...
     * 注册失败
     */
    const CODE_96001 = '96001';
    /***
     * 用户名已被注册过
     */
    const CODE_96002 = '96002';
    /***
     * 该手机号已被使用
     */
    const CODE_96003 = '96003';
    /***
     * 密码错误
     */
    const CODE_96004 = '96004';
    /***
     * 确认密码与密码不一致
     */
    const CODE_96005 = '96005';
    /***
     * 登录失败
     */
    const CODE_96006 = '96006';
    /***
     * 用户不存在
     */
    const CODE_96007 = '96007';
    /***
     * 修改失败
     */
    const CODE_96008 = '96008';
    /***
     * 账号锁定
     */
    const CODE_96009 = '96009';
    /***
     * 手机号错误
     */
    const CODE_97001 = '97001';
    /***
     * 验证码错误
     */
    const CODE_97002 = '97002';
    /***
     * 验证码发送失败
     */
    const CODE_97003 = '97003';
    /***
     * 未登录
     */
    const CODE_97004 = '97004';
    /***
     * 添加失败
     */
    const CODE_97005 = '97005';
    /***
     * 获取信息失败
     */
    const CODE_97006 = '97006';
    /***
     * 无权限
     */
    const CODE_97007 = '97007';
	...
	public static $errCodes = [
        ...
        self::CODE_32100=> '[下单判断]有有效订单',   // 【下单判断】有有效订单
        self::CODE_32101=> '[下单判断]未认证通过',  // 【下单判断】未认证通过

        //订单操作
        self::CODE_32200=>'[订单操作]订单不能评论',
        self::CODE_32201=>'[订单操作]订单评论失败',
        ...
        //商家平台
        self::CODE_96001=> '[商家]注册失败!',
        self::CODE_96002=> '[商家]用户名已被注册过!',
        self::CODE_96003=> '[商家]该手机号已被使用!',
        self::CODE_96004=> '[商家]密码错误!',
        self::CODE_96005=> '[商家]确认密码与密码不一致!',
        self::CODE_96006=> '[商家]登录失败!',
        self::CODE_96007=> '[商家]用户不存在!',
        self::CODE_96008=> '[商家]修改失败!',
        self::CODE_96009=> '[商家]账号锁定!',
        self::CODE_97001=> '[商家]手机号错误!',
        self::CODE_97002=> '[商家]验证码错误!',
        self::CODE_97003=> '[商家]验证码发送失败!',
        self::CODE_97004=> '[商家]未登录!',
        self::CODE_97005=> '[商家]添加失败!',
        self::CODE_97006=> '[商家]获取信息失败!',
        self::CODE_97007=> '[商家]无权限!',
    ];
