...
//        self::request(\env('APPID',1), \config('ordersystem.ORDER_API'),'api.giveback.confirm.delivery', '1.0', $value, $userInfo);
...
//			}
	...
	public static function confirmEvaluation( $params, $userInfo= [] ) {
        self::request(\env('APPID',1), \config('ordersystem.ORDER_API'),'api.giveback.confirm.evaluation', '1.0', $params, $userInfo);
