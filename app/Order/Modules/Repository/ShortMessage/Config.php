...
class Config {
     ...
     * @var int 210
     */
    const CHANNELID_COMPANY  = '210';
    /**
     * 渠道配置<b>【长城小程序】</b>
     * @var int 210
     */
    const CHANNELID_MINI_CHANGCHENG  = '30';
...
//				SceneConfig::ORDER_CREATE 			 	=> 'SMS_113461311', //用户下单
				SceneConfig::ORDER_CREATE 			 	=> 'SMS_113461373', //用户下单【统一调整4.11】
				
//                SceneConfig::ORDER_PAY 				 	=> 'SMS_113461043', //用户支付或授权 成功
                SceneConfig::ORDER_PAY 				 	=> 'SMS_113461374', //用户支付或授权 成功【统一调整4.11】
				
//                SceneConfig::ORDER_CANCEL               	=> 'SMS_113461044', //用户/后台/自动任务取消订单
                SceneConfig::ORDER_CANCEL               	=> 'SMS_113461375', //用户/后台/自动任务取消订单【统一调整4.11】
				
//                SceneConfig::ORDER_DELIVERY            	=> 'SMS_113461985', //订单发货短信
                SceneConfig::ORDER_DELIVERY            	=> 'SMS_113461377', //订单发货短信【统一调整4.11】
				
//                SceneConfig::ORDER_MONTH_RECEIVE    	    => 'SMS_113461146', //订单月租签收短信
                SceneConfig::ORDER_MONTH_RECEIVE    	    => 'SMS_113461378', //订单月租签收短信【统一调整4.11】
				
//                SceneConfig::ORDER_MONTH_BEFORE_MONTH_ENDING =>'SMS_113461128',//订单到期前一个月发送信息-月租【统一调整4.11 删除】
				
//                SceneConfig::ORDER_MONTH_BEFORE_WEEK_ENDING  =>'SMS_113461129',//订单到期前一周发送信息-月租
                SceneConfig::ORDER_MONTH_BEFORE_WEEK_ENDING  =>'SMS_113461394',//订单到期前一周发送信息-月租【统一调整4.11】
				
//                SceneConfig::ORDER_MONTH_OVER_MONTH_ENDING   =>'SMS_113461130',//订单逾期一个月发送信息-月租【统一调整4.11 删除】
				
//                SceneConfig::ORDER_DAY_BEFORE_ONE_ENDING     =>'SMS_113461158',//订单到期前一天发送信息-短租
                SceneConfig::ORDER_DAY_BEFORE_ONE_ENDING     =>'SMS_113461395',//订单到期前一天发送信息-短租【统一调整4.11】

//                SceneConfig::REFUND_APPLY_RISK_ACCEPT 			 	=> 'SMS_113461044', //申请退款1 风控审核通过【统一调整4.11 删除】
//                SceneConfig::REFUND_APPLY_RISK_REFUSE 			 	=> 'SMS_113461222', //申请退款2 风控未通过【统一调整4.11 删除】


//                SceneConfig::RETURN_APPLY 			 	=> 'SMS_113461054', //申请退货
                SceneConfig::RETURN_APPLY 			 	=> 'SMS_113461385', //申请退货【统一调整4.11】
				
//                SceneConfig::RETURN_APPLY_AGREE 	 	    => 'SMS_113461055', //退货审核通过
                SceneConfig::RETURN_APPLY_AGREE 	 	    => 'SMS_113461386', //退货审核通过【统一调整4.11】
				
//                SceneConfig::RETURN_APPLY_DISAGREE 		=> 'SMS_113461056', //退货审核不通过
                SceneConfig::RETURN_APPLY_DISAGREE 		=> 'SMS_113461386', //退货审核不通过【统一调整4.11】
				
//                SceneConfig::RETURN_CHECK_OUT 		 	=> 'SMS_113461058', //退货检测合格
                SceneConfig::RETURN_CHECK_OUT 		 	=> 'SMS_113461389', //退货检测合格【统一调整4.11】
				
//                SceneConfig::RETURN_UNQUALIFIED 	 	=> 'SMS_113461059', //退货检测不合格
                SceneConfig::RETURN_UNQUALIFIED 	 	=> 'SMS_113461389', //退货检测不合格【统一调整4.11】
				
//                SceneConfig::RETURN_DELIVERY 		 	=> 'SMS_113461057', //退货收到客户手机
                SceneConfig::RETURN_DELIVERY 		 	=> 'SMS_113461388', //退货收到客户手机【统一调整4.11】
				
//                SceneConfig::REFUND_SUCCESS 			=> 'SMS_113461060', //退款成功
                SceneConfig::REFUND_SUCCESS 			=> 'SMS_113461391', //退款成功【统一调整4.11】

				// 分期短信
//				SceneConfig::INSTALMENT_WITHHOLD 	 	=> 'SMS_113461050', //代扣扣款短信
				SceneConfig::INSTALMENT_WITHHOLD 	 	=> 'SMS_113461381', //代扣扣款短信【统一调整4.11】
				
//				SceneConfig::WITHHOLD_FAIL 		 		=> 'SMS_113461051', //扣款失败
				SceneConfig::WITHHOLD_FAIL 		 		=> 'SMS_113461382', //扣款失败【统一调整4.11】
				
//				SceneConfig::WITHHOLD_WARMED	 	 	=> 'SMS_113461052', //即将逾期
				SceneConfig::WITHHOLD_WARMED	 	 	=> 'SMS_113461383', //即将逾期【统一调整4.11】
				
//				SceneConfig::WITHHOLD_OVERDUE 		 	=> 'SMS_113461053', //扣款失败生成逾期
				SceneConfig::WITHHOLD_OVERDUE 		 	=> 'SMS_113461384', //扣款失败生成逾期【统一调整4.11】
				
//				SceneConfig::REPAYMENT 				 	=> 'SMS_113461067', //提前还款短信【统一调整4.11 删除】
//				SceneConfig::WITHHOLD_FAIL_INITIATIVE   => 'SMS_113461062', //扣款失败主动发送短信【统一调整4.11 删除】
				
//				SceneConfig::WITHHOLD_ADVANCE_ONE      	=> 'SMS_113461197', //提前一天还款短信
				SceneConfig::WITHHOLD_ADVANCE_ONE      	=> 'SMS_113461380', //提前一天还款短信【统一调整4.11】
				
//				SceneConfig::WITHHOLD_ADVANCE_THREE   	=> 'SMS_113461196', //提前三天 还款短信
				SceneConfig::WITHHOLD_ADVANCE_THREE   	=> 'SMS_113461379', //提前三天 还款短信【统一调整4.11】
				
//				SceneConfig::WITHHOLD_ADVANCE_SEVEN   	=> 'SMS_113461177', //提前七天 还款短信【统一调整4.11 删除】
				
//				SceneConfig::WITHHOLD_OVERDUEONE   		=> 'SMS_113461204', //扣款失败生成逾期 一天
				SceneConfig::WITHHOLD_OVERDUEONE   		=> 'SMS_113461411', //扣款失败生成逾期 一天【统一调整4.11】
				
//				SceneConfig::WITHHOLD_OVERDUETHREE   	=> 'SMS_113461205', //扣款失败生成逾期 三天
				SceneConfig::WITHHOLD_OVERDUETHREE   	=> 'SMS_113461412', //扣款失败生成逾期 三天【统一调整4.11】
				
//				SceneConfig::CRONREPAYMENT				=> 'SMS_113461070', //月初发送提前还款短信【统一调整4.11 删除】

				//还机
//				SceneConfig::GIVEBACK_CREATE 			    => 'SMS_113461131', //还机申请
				SceneConfig::GIVEBACK_CREATE 			    => 'SMS_113461396', //还机申请【统一调整4.11】
				
//				SceneConfig::GIVEBACK_CONFIRMDELIVERY 	=> 'SMS_113461132', //还机确认收货 有剩余的租金
				SceneConfig::GIVEBACK_CONFIRMDELIVERY 	=> 'SMS_113461399', //还机确认收货 有剩余的租金【统一调整4.11】
				
//				SceneConfig::GIVEBACK_CONFIRMNOWITH     	=> 'SMS_113461159', //还机确认收货 无剩余的租金
				SceneConfig::GIVEBACK_CONFIRMNOWITH     	=> 'SMS_113461397', //还机确认收货 无剩余的租金【统一调整4.11】
				
//				SceneConfig::GIVEBACK_WITHHOLDSUCCESS 	=> 'SMS_113461135', //系统执行代扣成功后发送
				SceneConfig::GIVEBACK_WITHHOLDSUCCESS 	=> 'SMS_113461400', //系统执行代扣成功后发送【统一调整4.11】
				
//				SceneConfig::GIVEBACK_WITHHOLDFAIL	 	=> 'SMS_113461136', //系统执行代扣成功后发送
				SceneConfig::GIVEBACK_WITHHOLDFAIL	 	=> 'SMS_113461401', //系统执行代扣成功后发送【统一调整4.11】
				
//				SceneConfig::GIVEBACK_PAYMENT	 		    => 'SMS_113461137', //财务收到用户剩余租金成功时发送
				SceneConfig::GIVEBACK_PAYMENT	 		    => 'SMS_113461398', //财务收到用户剩余租金成功时发送【统一调整4.11】
				
//				SceneConfig::GIVEBACK_EVANOWITYESENONO	=> 'SMS_113461139', //库管点击检测不合格、输入赔偿金额时发送
				SceneConfig::GIVEBACK_EVANOWITYESENONO	=> 'SMS_113461404', //库管点击检测不合格、输入赔偿金额时发送【统一调整4.11】
				
//				SceneConfig::GIVEBACK_EVANOWITYESENO   	=> 'SMS_113461140', //库管点击检测不合格、输入赔偿金额时发送
				SceneConfig::GIVEBACK_EVANOWITYESENO   	=> 'SMS_113461405', //库管点击检测不合格、输入赔偿金额时发送【统一调整4.11】
				
//				SceneConfig::GIVEBACK_EVANOWITNOENONO	=> 'SMS_113461141', //库管点击检测不合格、输入赔偿金额时发送
				SceneConfig::GIVEBACK_EVANOWITNOENONO	=> 'SMS_113461406', //库管点击检测不合格、输入赔偿金额时发送【统一调整4.11】
				
//                SceneConfig::GIVEBACK_EVANOWITNOENO	 	=> 'SMS_113461142', //库管点击检测不合格、输入赔偿金额时发送
                SceneConfig::GIVEBACK_EVANOWITNOENO	 	=> 'SMS_113461407', //库管点击检测不合格、输入赔偿金额时发送【统一调整4.11】
				
//				SceneConfig::GIVEBACK_RETURNDEPOSIT	 	=> 'SMS_113461138', //财务系统完成押金退还时发送
				SceneConfig::GIVEBACK_RETURNDEPOSIT	 	=> 'SMS_113461403', //财务系统完成押金退还时发送【统一调整4.11】
				//买断
//				SceneConfig::BUYOUT_CONFIRM					=> 'SMS_113461144', //买断确认短信
				SceneConfig::BUYOUT_CONFIRM					=> 'SMS_113461408', //买断确认短信【统一调整4.11】
				
//				SceneConfig::BUYOUT_PAYMENT					=> 'SMS_113461145', //买断支付短信
				SceneConfig::BUYOUT_PAYMENT					=> 'SMS_113461409', //买断支付短信【统一调整4.11】
				
//				SceneConfig::BUYOUT_PAYMENT_END				=> 'SMS_113461161', //买断完成短信

                //退押金
//                SceneConfig::RETURN_DEPOSIT				=> 'SMS_113461138', //财务系统完成押金退还时发送【统一调整4.11 删除】


//                SceneConfig::DESTINE_CREATE              => 'SMS_113461183', //订金退款申请短信【统一调整4.11 删除】
//                SceneConfig::DESTINE_REFUND              => 'SMS_113461184  ',//订金退款成功短信【统一调整4.11 删除】
                ...
                //到期未做任何操作
                SceneConfig::ORDER_OVERDUE_NO_OPERATION =>'SMS_113461413',
...
//
//                SceneConfig::ORDER_MONTH_RECEIVE        => 'SMS_113461359', //订单月租签收短信-----新
//                SceneConfig::ORDER_DAY_RECEIVE      	=> 'SMS_113461359', //订单日租签收短信-----新
//                SceneConfig::ORDER_MONTH_BEFORE_WEEK_ENDING  =>'SMS_113461366',//订单到期前一周发送信息-月租-----新
//                SceneConfig::ORDER_DAY_BEFORE_ONE_ENDING     =>'SMS_113461367',//订单到期前一天发送信息-长短租-----新
//
//                SceneConfig::RETURN_UNQUALIFIED 	 	=> 'SMS_113461365', //退货检测不合格  -----新
//                SceneConfig::RETURN_DELIVERY 		 	=> 'SMS_113461364', //退货收到客户手机  -----新
//
//                // 分期短信
//                SceneConfig::WITHHOLD_ADVANCE_THREE   	=> 'SMS_113461360', //提前三天 还款短信-----新
//                SceneConfig::WITHHOLD_FAIL_INITIATIVE   => 'SMS_113461361', //扣款失败主动发送短信
//                SceneConfig::WITHHOLD_OVERDUEONE   		=> 'SMS_113461362', //扣款失败生成逾期 一天
//                SceneConfig::WITHHOLD_OVERDUETHREE   	=> 'SMS_113461363', //扣款失败生成逾期 三天
//                //买断
//                SceneConfig::BUYOUT_PAYMENT					=> 'SMS_113461368', //买断支付短信----新
//                SceneConfig::BUYOUT_PAYMENT_END				=> 'SMS_113461368', //买断完成短信
//
//
//			],
            // 苹果小程序
...
//            ],
            ...
            // 企业租赁
            self::CHANNELID_COMPANY => [
                SceneConfig::COMPANY_CHECK_REJECT 			 	=> 'SMS_113461307', //企业信息审核驳回
                SceneConfig::COMPANY_CHECK_ACCEPT            	=> 'SMS_113461306', //企业信息审核通过
            ],
		];
