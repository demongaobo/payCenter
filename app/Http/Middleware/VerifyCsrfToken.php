...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = [
		...
		'/zhaijisong/test',					// 宅急送运单状态通知
		'/zhaijisong/stateNotify',				// 宅急送运单状态通知
        '/zhaijisong/zjsOrder',				// 宅急送下单通知
        '/zhaijisong/logisticsQuery',		// 宅急送物流轨迹查询
        '/zhaijisong/logisticsNumber',		// 宅急送快递单号获取
        '/zhaijisong/reinsurancePolicy',				// 宅急送分单
