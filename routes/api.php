...
$api->version('v1', [
    ...
    $api->post('trade/notify', 'TradeController@notify'); //支付回调接口
        ...
        //隊列评论订单商品
        $api->any('OrderGoodsDiscuss', 'InnerServiceController@OrderGoodsDiscuss');
    ...
    // 定时任务 评论订单
    $api->get('cronOrderDiscuss', 'CronController@cronOrderDiscuss');
...
$api->version('v1', [
    ...
    $api->any('ShopHeader', 'ShopAuthRefferController@ShopHeader');
    $apiMap = [
        'third.wechat.jsapi.sign' => 'WechatJsapiController@sign',
        'third.auth.url' => 'ThirdAuthController@getUrl',
        'third.auth.query' => 'ThirdAuthController@query',
